...
int Pkt::getNop() const
{
    return this->nop;
}

void Pkt::setNop(int nop)
{
    this->nop = nop;
}

const char * Pkt::getType() const
{
    return this->type.c_str();
}

void Pkt::setType(const char * type)
{
    this->type = type;
}
...
int PktDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='n' && strcmp(fieldName, "nop")==0) return base+3;
...
std::string PktDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 3: return long2string(pp->getNop());
        case 4: return oppstring2string(pp->getType());
        default: return "";
    }
}
...
bool PktDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 3: pp->setNop(string2long(value)); return true;
        case 4: pp->setType((value)); return true;
